...
let filteredTable = entrepreneurs.filter(function(entrepreneur) {
...
let filteredTableForName = entrepreneurs.filter(function(entrepreneur) {
...
console.log("Voici l'âge qu'aurait chaque inventeur aujourd'hui:")
let ageToday = entrepreneurs.filter(function(entrepreneur) {
...
let filteredTableByAlphabet = entrepreneurs.filter(function(entrepreneur) {
  return console.log(entrepreneur.last);
});
